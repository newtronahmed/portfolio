	...
	return (
		<div id='App' >
			...
			<motion.div variants={containerVariants} initial='init' animate='end' className="w-full min-h-screen wow  bg-fixed bg-cover bg-center flex items-center justify-center flex-wrap content-center  " id="banner" >
				...
				<motion.div variants={childrenVariant} className="p-4 w-100 flex justify-center ">
					<a href="/assets/resume.pdf" target="_blank" download className=" bg-black rounded p-2 text-white flex items-center ">
						RESUME<svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
